...
<CardBody className="bg-ecru relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-[21rem] sm:w-[22rem] h-auto p-3">
      ...
      <div className="w-full h-24 bg-orange_card rounded-b-2xl flex flex-col justify-between items-center">
        <h2 className="text-3xl text-black mt-3">COTILLÓN</h2>      
        <div>
          <Link to="/cotillon"><p className="mt-4 text-2xl text-white hover:drop-shadow-custom hover:text-black">Ver productos</p></Link>
        </div>
      </div>
    </CardContainer>
